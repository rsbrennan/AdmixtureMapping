...
~/bin/samtools-1.3.1/samtools view -b -h -F 0x0004 -F 0x0400 ~/admixture_mapping/processed_data/aligned/CB-1/cb-1.all.bam | \
bedtools coverage -abam stdin \
-b ~/reference/SbfI_List.bed -b \
> ~/admixture_mapping/summary_files/cb-1.bam.hist.all.txt
