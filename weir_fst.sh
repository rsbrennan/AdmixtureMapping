...
P1=PP
P2=PL
cat  ~/admixture_mapping/scripts/poplists/${P1}.pop  ~/admixture_mapping/scripts/poplists/${P2}.pop \
...
--weir-fst-pop ~/admixture_mapping/scripts/poplists/${P1}.pop \
--weir-fst-pop ~/admixture_mapping/scripts/poplists/${P2}.pop \
--out ${P1}_vs_${P2}
