...
lib=AC-5
indir=~/admixture_mapping/processed_data/radtag_checked/AC/run-1/$lib/
...
outdir=~/admixture_mapping/processed_data/aligned/AC/run-1/$lib/
...
rg=$(echo \@RG\\tID:$lib\-$root\\tPL:Illumina\\tPU:x\\tLB:run1-$lib\\tSM:$root)
tempsort=$root.temp
