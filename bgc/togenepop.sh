...
java -Xmx20024m -Xms512M -jar ~/bin/PGDSpider_2.1.0.3/PGDSpider2-cli.jar -inputfile ~/admixture_mapping/variants/${POP}.thin.ped -inputformat PED -outputfile ${POP}.genepop -outputformat GENEPOP -spid ~/admixture_mapping/scripts/bgc/${POP}.genepop.spid
